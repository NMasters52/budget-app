...
const Nav = () => {
  ...
  const activeLink =
    "underline underline-offset-4 text-white text-lg font-semibold";
  const inactiveLink =
    "text-white text-lg font-semibold hover:underline underline-offset-4";
  ...
  return (
    <nav className="p-4 bg-green-600 flex flex-row mb-6 justify-between items-center w-full mx-auto">
      <div className="bg-white flex p-2 rounded items-center ml-5">
        <img
          src="/bill.png"
